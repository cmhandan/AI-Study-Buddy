...
import { GraduationCap, Mail, Lock, Eye, EyeOff, User, AlertCircle, Loader } from 'lucide-react';
...
const Register: React.FC = () => {
  ...
  const passwordStrength = () => {
    ...
    if (password.length < 8) return { label: 'Weak', color: 'bg-amber-500', width: 'w-1/2' };
